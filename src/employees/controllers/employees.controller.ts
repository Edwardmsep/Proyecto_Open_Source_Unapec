...
export class EmployeesController {
    ...
    @Put('/update/:id')
    async updateClient(@Res() res, @Param('id') employeesId, @Body() createdEmployeestDto: EmployeesDto){
        const employees = await this.employeesService.update(employeesId,createdEmployeestDto)
